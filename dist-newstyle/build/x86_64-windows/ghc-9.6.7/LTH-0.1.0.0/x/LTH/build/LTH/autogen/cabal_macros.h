...
/* package LTH-0.1.0.0 */
#ifndef VERSION_LTH
#define VERSION_LTH "0.1.0.0"
#endif /* VERSION_LTH */
#ifndef MIN_VERSION_LTH
#define MIN_VERSION_LTH(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LTH */
...
#define CURRENT_COMPONENT_ID "LTH-0.1.0.0-inplace-LTH"
